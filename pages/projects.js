export default function Projects() {
	return (
		<div className="md:mx-0 my-16 flex flex-col text-text justify-center">
			<div className="grid grid-flow-row md:grid-cols-3 auto-rows-max gap-6 justify-items-stretch">
				<div className="md:justify-self-end font-bold">
					Debate It
				</div>
